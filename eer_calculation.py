...
def cal_metric(groundTruth, predicted):
	...
	FPR = {"TPR(1.%)": 0.01, "TPR(.5%)": 0.005, "TPR(.2%)":0.002, "TPR(.05%)":0.0005 } 		#, "TPR(5%)" : 0.05, "TPR(10%)" : 0.1, "TPR(50%)" : 0.5

	TPRs = {"TPR(1.%)": 0, "TPR(.5%)": 0, "TPR(.2%)": 0, "TPR(.05%)":0} 				# , "TPR(5%)" : 0, "TPR(10%)" : 0, "TPR(50%)" : 0
