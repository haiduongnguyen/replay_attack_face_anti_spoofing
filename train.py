...
if __name__ == '__main__':
    ...
    # b0_ver_1 = config_to_train(model_name='b0_ver_1',
    ...
    b0_ver_2 = config_to_train(model_name='b0_ver_1',
                                initial_model='/home/duongnh/project_f19/photo_attack/result/b0_ver_2/train/checkpoint_b0_ver_2/cp_16.h5', 
                                INIT_LR=3e-5 )
    b0_ver_2.train()
    b0_ver_2.eval()
    ...
    b4_ver_2 = config_to_train(model_name='b4_ver_1', 
                                initial_model='/home/duongnh/project_f19/photo_attack/result/b4_ver_1/train/checkpoint_b4_ver_1/cp_02.h5', 
                                INIT_LR=3e-5, img_height=380, img_width=380 )
    b4_ver_2.train()
    b4_ver_2.eval()